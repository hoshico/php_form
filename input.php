...
性別
    ...
    <select class="form-control" id="name" name="age">
    ...
    <textarea class="form-control" id="contact" row="3" row="3" name="contact">
    ...
    <div class="form-check">
      ...
      <label class="form-check-input" for="caution">注意事項のチェック</label>
    </div>
